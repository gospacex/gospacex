...
func (tg *TemplateESCRUDGenerator) generateModel() error {
	...
	templatePath := resolveTemplatePath("internal", "model", "es_entity.go.tmpl")
...
func (tg *TemplateESCRUDGenerator) generateService() error {
	data := tg.getTemplateData()
	templatePath := resolveTemplatePath("internal", "service", "es_entity_service.go.tmpl")
...
func (tg *TemplateESCRUDGenerator) generateHandler() error {
	data := tg.getTemplateData()
	templatePath := resolveTemplatePath("internal", "handler", "es_entity_handler.go.tmpl")
...
func (tg *TemplateESCRUDGenerator) generateCommand() error {
	data := tg.getTemplateData()
	templatePath := resolveTemplatePath("cmd", "commands", "es_entity.go.tmpl")
