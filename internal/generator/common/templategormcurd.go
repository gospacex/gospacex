...
func (tg *TemplateCRUDGenerator) generateModel() error {
	...
	templatePath := resolveTemplatePath("crud", "gorm_model.go.tmpl")
...
func (tg *TemplateCRUDGenerator) generateRepositoryInterface() error {
	...
	templatePath := resolveTemplatePath("crud", "gorm_repository_interface.go.tmpl")
	content, err := tg.renderTemplate(templatePath, data)
	if err != nil {
		return err
	}
...
func (tg *TemplateCRUDGenerator) generateRepositoryImpl() error {
	...
	templatePath := resolveTemplatePath("crud", "gorm_repository_impl.go.tmpl")
	content, err := tg.renderTemplate(templatePath, data)
	if err != nil {
		return err
	}
...
func (tg *TemplateCRUDGenerator) generateService() error {
	...
	templatePath := resolveTemplatePath("crud", "gorm_service.go.tmpl")
	content, err := tg.renderTemplate(templatePath, data)
	if err != nil {
		return err
	}
...
func (tg *TemplateCRUDGenerator) generateDALInit() error {
	...
	templatePath := resolveTemplatePath("crud", "gorm_dal_init.go.tmpl")
	content, err := tg.renderTemplate(templatePath, data)
	if err != nil {
		return err
	}
